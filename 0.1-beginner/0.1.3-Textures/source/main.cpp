// Textrues.cpp : 此文件包含 "main" 函数。程序执行将在此处开始并结束。
//
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "very good textrues", NULL, NULL);
    if (window == NULL)
    {
    ...
    Shader myShader("shaderCode/texture.vs", "shaderCode/texture.fs");
